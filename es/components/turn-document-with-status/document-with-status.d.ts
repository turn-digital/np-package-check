...
declare const CDSDocumentsWithStatus_base: {
    new (...args: any[]): {
        focus(): void;
        accessKey: string;
 ...
 */
declare class CDSDocumentsWithStatus extends CDSDocumentsWithStatus_base {
    title: string;
    /**
...
//# sourceMappingURL=document-with-status.d.ts.map
